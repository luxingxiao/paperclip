        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            ...
            <div className="mt-2 flex items-center gap-2 text-[11px] text-muted-foreground">
              <span>
                {isActive
                  ? t("activeAgentsPanel.liveNow")
                  : run.finishedAt
                    ? t("activeAgentsPanel.finished", { time: relativeTime(run.finishedAt) })
                    : t("activeAgentsPanel.started", { time: relativeTime(run.createdAt) })}
              </span>
            </div>
          </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-3">
        <RunTranscriptView
          ...
          emptyMessage={hasOutput
            ? t("activeAgentsPanel.waitingTranscript")
            : isActive
              ? t("activeAgentsPanel.waitingOutput")
              : t("activeAgentsPanel.noTranscript")}
        />
      </div>
    </div>
  );
