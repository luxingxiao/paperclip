...
export function NewProjectDialog() {
  ...
  const projectStatuses = [
    { value: "backlog", label: t("newProjectDialog.statusBacklog") },
    { value: "planned", label: t("newProjectDialog.statusPlanned") },
    { value: "in_progress", label: t("newProjectDialog.statusInProgress") },
    { value: "completed", label: t("newProjectDialog.statusCompleted") },
    { value: "cancelled", label: t("newProjectDialog.statusCancelled") },
  ];
