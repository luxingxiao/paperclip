...
export function NewGoalDialog() {
  ...
  const levelLabels: Record<string, string> = {
    company: t("newGoalDialog.levelCompany"),
    team: t("newGoalDialog.levelTeam"),
    agent: t("newGoalDialog.levelAgent"),
    task: t("newGoalDialog.levelTask"),
  };
  const statusLabels: Record<string, string> = {
    planned: t("newGoalDialog.statusPlanned"),
    active: t("newGoalDialog.statusActive"),
    achieved: t("newGoalDialog.statusAchieved"),
    cancelled: t("newGoalDialog.statusCancelled"),
  };
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>
              {newGoalDefaults.parentId
                ? t("newGoalDialog.newSubGoal")
                : t("newGoalDialog.newGoal")}
            </span>
          </div>
