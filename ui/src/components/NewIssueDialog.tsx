              ...
              {executionWorkspaceMode === "reuse_existing" && selectedReusableExecutionWorkspace && (
                <div className="text-[11px] text-muted-foreground">
                  {t("newIssueDialog.reusingWorkspace", {
                    ...
                    source: selectedReusableExecutionWorkspace.branchName ?? selectedReusableExecutionWorkspace.cwd ?? t("newIssueDialog.existingExecutionWorkspace"),
                  })}
                </div>
              )}
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? t("newIssueDialog.creating") : isSubIssueMode ? "Create Sub-Issue" : t("newIssueDialog.createIssue")}</span>
              </span>
            </Button>
          </div>
        </div>
