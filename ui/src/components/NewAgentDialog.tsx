...
const ADVANCED_ADAPTER_OPTIONS: Array<{
  ...
  },
  {
    ...
    label: "Gemini CLI",
    icon: Gem,
    descKey: "adapterGeminiDesc",
  },
  {
    value: "opencode_local",
    label: "OpenCode",
    icon: OpenCodeLogoIcon,
    descKey: "adapterOpenCodeDesc",
  },
  {
    value: "hermes_local",
    label: "Hermes Agent",
  ...
  },
  {
    ...
    label: "Pi",
    icon: Terminal,
    descKey: "adapterPiDesc",
  },
  {
    value: "cursor",
    label: "Cursor",
    icon: MousePointer2,
    descKey: "adapterCursorDesc",
  },
  {
    value: "openclaw_gateway",
    label: "OpenClaw Gateway",
    icon: Bot,
    descKey: "adapterOpenclawDesc",
  },
];
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("newAgentDialog.header")}</span>
          <Button
            variant="ghost"
            size="icon-xs"
