...
export function Routines() {
  ...
  const concurrencyPolicyDescriptions: Record<string, string> = {
    coalesce_if_active: t("routines.coalesceIfActiveDesc"),
    always_enqueue: t("routines.alwaysEnqueueDesc"),
    skip_if_active: t("routines.skipIfActiveDesc"),
  };
  const catchUpPolicyDescriptions: Record<string, string> = {
    skip_missed: t("routines.skipMissedDesc"),
    enqueue_missed_with_cap: t("routines.enqueueMissedWithCapDesc"),
  };
                      ...
                      <td className="px-3 py-2.5" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            aria-label={enabled ? t("routines.disable") : t("routines.enable")}
                          ...
                          <span className="text-xs text-muted-foreground">
                            {isArchived ? t("routines.archived") : enabled ? t("common.on") : t("common.off")}
                          </span>
                        </div>
                      </td>
                      <td className="px-3 py-2.5 text-right" onClick={(e) => e.stopPropagation()}>
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="icon-sm" aria-label={t("routines.moreActions")}>
