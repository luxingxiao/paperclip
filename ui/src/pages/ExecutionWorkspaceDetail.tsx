...
export function ExecutionWorkspaceDetail() {
  ...
  useEffect(() => {
    ...
    const crumbs = [
      ...
      ...(project ? [{ label: t("executionWorkspaceDetail.workspaces"), href: `/projects/${projectRef}/workspaces` }] : []),
  ...
  const controlRuntimeServices = useMutation({
    ...
    onSuccess: (result, action) => {
      ...
      setRuntimeActionMessage(
        action === "stop"
          ? t("executionWorkspaceDetail.servicesStopped")
          : action === "restart"
            ? t("executionWorkspaceDetail.servicesRestarted")
            : t("executionWorkspaceDetail.servicesStarted"),
      );
    },
    onError: (error) => {
      setRuntimeActionMessage(null);
      setErrorMessage(error instanceof Error ? error.message : t("executionWorkspaceDetail.failedToControlServices"));
    },
  });
      ...
      <div className="mx-auto max-w-5xl space-y-4 overflow-hidden sm:space-y-6">
        <div className="flex flex-wrap items-center gap-3">
          <Button variant="ghost" size="sm" asChild>
            <Link to={project ? `/projects/${projectRef}/workspaces` : "/projects"}>
              ...
              {t("executionWorkspaceDetail.backToWorkspaces")}
            </Link>
          </Button>
        ...
        <div className="space-y-2">
          <div className="text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground">
            {t("executionWorkspaceDetail.label")}
          </div>
          <h1 className="truncate text-xl font-semibold sm:text-2xl">{workspace.name}</h1>
          <p className="max-w-2xl text-sm text-muted-foreground">
            {t("executionWorkspaceDetail.description")}
            <span className="hidden sm:inline"> {t("executionWorkspaceDetail.descriptionDetail")}</span>
          </p>
        </div>
          ...
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(18rem,0.95fr)]">
              ...
              <div className="rounded-2xl border border-border bg-card p-4 sm:p-5">
                <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
                  <div className="space-y-1">
                    <div className="text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground">
                      {t("executionWorkspaceDetail.tabConfiguration")}
                    </div>
                    <h2 className="text-lg font-semibold">{t("executionWorkspaceDetail.workspaceSettings")}</h2>
                    <p className="text-sm text-muted-foreground">
                      {t("executionWorkspaceDetail.workspaceSettingsDesc")}
                    </p>
                  </div>
                  <Button
                    variant="outline"
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  ...
                  <Field label={t("executionWorkspaceDetail.providerRef")}>
                    <input
                      className="w-full rounded-lg border border-border bg-background px-3 py-2 font-mono text-sm outline-none"
            ...
            <div className="min-w-0 space-y-4 sm:space-y-6">
              ...
              <div className="rounded-2xl border border-border bg-card p-4 sm:p-5">
                ...
                <DetailRow label={t("executionWorkspaceDetail.providerRefLabel")}>
              ...
              <div className="rounded-2xl border border-border bg-card p-4 sm:p-5">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t("executionWorkspaceDetail.runtimeSource")}: {runtimeConfigSource === "execution_workspace"
                ...
                {workspace.runtimeServices && workspace.runtimeServices.length > 0 ? (
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                          <div className="space-y-1">
                            ...
                            <div className="space-y-1 text-xs text-muted-foreground">
                              ...
                              {service.port ? <div>{t("executionWorkspaceDetail.port")} {service.port}</div> : null}
                  ...
                  <p className="text-sm text-muted-foreground">
                    {effectiveRuntimeConfig
                      ? t("executionWorkspaceDetail.noServicesRunning")
