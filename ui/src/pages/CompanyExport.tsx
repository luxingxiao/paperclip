  ...
  const downloadMutation = useMutation({
    ...
    onSuccess: (result) => {
      ...
      pushToast({
        ...
        body: t("companyExport.exportDownloadedBody", { count: resultCheckedFiles.size, name: result.rootPath }),
      });
    },
    onError: (err) => {
      pushToast({
        tone: "error",
        title: t("companyExport.exportFailed"),
        body: err instanceof Error ? err.message : t("companyExport.failedToBuildExportPackage"),
      });
    },
  });
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-4 text-sm">
            <span className="font-medium">
              {t("companyExport.companyExportHeading", { name: selectedCompany?.name ?? t("companyExport.companyFallback") })}
            </span>
          ...
          >
            ...
            {downloadMutation.isPending
              ...
              : t("companyExport.exportNFiles", { count: selectedCount })}
          </Button>
        </div>
      </div>
