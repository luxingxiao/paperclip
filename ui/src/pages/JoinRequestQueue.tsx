    ...
    <div className="max-w-6xl space-y-6">
      ...
      <div className="flex flex-wrap gap-3 rounded-xl border border-border bg-card p-4">
        <label className="space-y-2 text-sm">
          ...
          >
            <option value="pending_approval">{t("joinRequestQueue.statusPendingApproval")}</option>
        ...
        <label className="space-y-2 text-sm">
          ...
          >
            <option value="all">{t("joinRequestQueue.requestTypeAll")}</option>
            <option value="human">{t("joinRequestQueue.requestTypeHuman")}</option>
            <option value="agent">{t("joinRequestQueue.requestTypeAgent")}</option>
          </select>
        </label>
      </div>
            ...
            <div key={request.id} className="rounded-xl border border-border bg-card p-4">
              ...
              <div className="mt-4 grid gap-3 text-sm text-muted-foreground md:grid-cols-2">
                ...
                <div className="rounded-lg border border-border bg-background px-3 py-2">
                  ...
                  <div className="mt-2">{t("joinRequestQueue.submitted", { date: new Date(request.createdAt).toLocaleString() })}</div>
