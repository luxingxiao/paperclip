...
export function BoardClaimPage() {
  ...
  if (!status) {
    return <div className="mx-auto max-w-xl py-10 text-sm text-destructive">{t("boardClaim.challengeUnavailableTitle")}.</div>;
  }
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">{t("boardClaim.heading")}</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("boardClaim.desc")}
        </p>
