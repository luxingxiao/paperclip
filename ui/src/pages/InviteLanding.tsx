...
export function InviteLandingPage() {
  ...
  if (result?.kind === "bootstrap") {
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          <h1 className="text-lg font-semibold">{t("invite.bootstrapTitle")}</h1>
          <p className="mt-2 text-sm text-muted-foreground">
    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">
          {invite.inviteType === "bootstrap_ceo" ? t("invite.bootstrapInviteTitle") : t("invite.joinTitle")}
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">{t("invite.inviteExpiry", { time: dateTime(invite.expiresAt) })}</p>
