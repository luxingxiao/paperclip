          ...
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              <div className="space-y-1">
                <h2 className="text-base font-semibold">{t("pluginSettings.settingsHeading")}</h2>
              </div>
                              ...
                              <>
                                <div className="flex justify-between col-span-2">
                                  ...
                                  <span className="text-xs">
                                    {t("pluginSettings.consecutiveTotal", { consecutive: dashboardData.worker.consecutiveCrashes, total: dashboardData.worker.totalCrashes })}
                                  </span>
                                </div>
                  ...
                  {healthLoading ? (
                    ...
                    <div className="space-y-4 text-sm">
                      ...
                      {healthData.lastError ? (
                        <div className="wrap-break-word rounded border border-destructive/20 bg-destructive/10 p-2 text-xs text-destructive">
                          {healthData.lastError}
                        </div>
                      ) : null}
                    </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <div className="flex justify-between gap-3">
                    ...
                    <span className="max-w-42.5 truncate text-right text-xs" title={plugin.packageName}>
                      {plugin.packageName}
                    </span>
                  </div>
                  <div className="flex justify-between gap-3">
